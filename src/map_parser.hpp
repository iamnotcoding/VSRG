...
namespace map_parser
{
	...
	*/
	...
	// object : a string which consists of two characters, like "00", "0A", "1B", etc.
	...
	struct Header
	{
		...
		unordered_map<string, string> audios; // <object, path>
		// Frames of a BGA
		unordered_map<string, string> bitmaps; // <object, path>
